    ...
    fCapsLock(false)
{
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ...
            setWindowTitle(tr("Encrypt Piggy Bank"));
            break;
        case Unlock: // Ask passphrase
            ...
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Unlock Piggy Bank"));
            break;
        case Decrypt:   // Ask passphrase
            ...
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Decrypt Piggy Bank"));
            break;
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         "<qt>" +
                                         tr("Nintencoin will close now to finish the encryption process. "
                                         "Remember that encrypting your wallet cannot fully protect "
                                         "your nintencoins from being stolen by malware infecting your computer.") +
                                         "<br><br><b>" +
