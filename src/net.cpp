...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nintencoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nintencointools.com", "dnsseed.nintencointools.com"},
    {"nintencoinpool.org", "dnsseed.nintencoinpool.org"},
    {"xurious.com", "dnsseed.nin.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nintencointools.com", "testnet-seed.nintencointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nintencoin is probably already running."), addrBind.ToString().c_str());
        else
